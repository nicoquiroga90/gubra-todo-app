  ...
  return (
    <div className="bg-[#fef68a] rounded-lg p-3 flex flex-col shadow-lg shadow-gray-600/10">
      ...
      <div className="flex gap-10 justify-between items-center">
        ...
        <button
          onClick={handleClick}
          className={`px-3 py-2 font-bold text-black rounded-full shadow-md transition-all duration-300 ease-in-out font-poppins 
        ${
          done
            ? "bg-green-400 hover:bg-green-600 border-black"
            : "bg-yellow-400 hover:bg-yellow-600 border-black"
        } 
        border-2`}
        >
          {done ? "Done 🎉" : "Pending ❗"}
